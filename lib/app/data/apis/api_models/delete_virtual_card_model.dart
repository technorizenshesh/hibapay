class DeleteVirtualCardModel {
  String? status;
  String? message;
  DeleteVirtualCardResult? result;
  String? token;

  DeleteVirtualCardModel({this.status, this.message, this.result, this.token});

  DeleteVirtualCardModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    result = json['result'] != null
        ? DeleteVirtualCardResult.fromJson(json['result'])
        : null;
    token = json['token'];
  }
...
class DeleteVirtualCardResult {
  ...
  DeleteVirtualCardResult.fromJson(Map<String, dynamic> json) {
