...
class RechargeController extends GetxController {
  ...
  final icMobileNumber = false.obs;
  final icAmount = false.obs;
  final icServiceProvider = false.obs;
  ...
  Future<void> onInit() async {
    ...
    serviceId = parameters[ApiKeyConstants.serviceId] ?? '';
    super.onInit();
    startListener();
  ...
  void onFocusChange() {
    icMobileNumber.value = focusMobileNumber.hasFocus;
    icAmount.value = focusAmount.hasFocus;
    icServiceProvider.value = focusServiceProvider.hasFocus;
  }
